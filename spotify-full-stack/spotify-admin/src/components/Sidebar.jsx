  ...
  return (
    <div className="bg-[#003A10] min-h-screen pl-[4vw]">
      ...
      <img
        ...
        className="mt-5 w-[max(5vw,40px)] ,r-5 sm:hidden block"
        alt=""
      />
      <div className="flex flex-col gap-5 mt-10">
        <NavLink
          to="/add-song"
          className="flex items-center gap-2.5 text-gray-800 bg-white border p-2 pr-[max(8vw,10px)] drop-shadow-[-4px_4px_#00FF5B] text-sm font-medium"
        >
